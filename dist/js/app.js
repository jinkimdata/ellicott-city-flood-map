...
var ellicottCityFloodMap = {
    ...
    share: function() {
        $(".icon-twitter").on("click", function() {
            var tweet = "See how Ellicott City's once-in-a-millenium flood unfolded in this interactive map.";
            var url = "http://data.baltimoresun.com/news/ellicott-city-flood-map/";
            var twitter_url = "https://twitter.com/intent/tweet?text=" + tweet + "&url=" + url + "&tw_p=tweetbutton";
            window.open(twitter_url, "mywin", "left=200,top=200,width=500,height=300,toolbar=1,resizable=0");
            return false;
        });
        $(".icon-facebook").on("click", function() {
            var picture = "http://data.baltimoresun.com/news/ellicott-city-flood-map/images/thumb.png";
            var title = "Ellicott City Flood Timeline";
            var description = "See how Ellicott City's once-in-a-millenium flood unfolded in this interactive map.";
            var url = "http://data.baltimoresun.com/news/ellicott-city-flood-map/";
